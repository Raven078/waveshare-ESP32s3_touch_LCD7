...
void ui_create_wallpaper(void)
{
    ...
    lv_obj_set_style_text_font(title_label, &my_arial, 0);
    ...
    lv_obj_set_style_text_font(info_label, &my_arial, 0);
    ...
    lv_obj_set_style_text_font(time_label, &my_arial, 0);
